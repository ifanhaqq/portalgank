            ...
            <div class="container" style="margin-top: 12vh;">
                <div class="row d-flex justify-content-center">
                    <div class="col-7 bg-black mt-4 rounded-4 mt-5 d-flex justify-content-between">
                        ...
                        <h1 class="text-white fw-bolder align-self-center me-4 align-self-center">{{ $totalArticle }}</h1>
                    </div>
                </div>
                <div class="row d-flex justify-content-center mt-4">
                    <div class="col-7 bg-secondary rounded-4 d-flex justify-content-between">
                        ...
                        <h1 class="text-white fw-bolder align-self-center me-4">{{ $todayReport }}</h1>
                    </div>
                </div>
                <div class="row d-flex justify-content-center mt-4">
                    <div class="col-7 rounded-4" style="background-color: rgba(120, 5, 5, 1)">
                        <div class=" d-flex justify-content-between border-bottom border-3">
                            ...
                            <h5 class="text-white fw-bolder align-self-center me-4"><em>{{ $totalReport }}</em></h5>
                        </div>
                        <div class=" d-flex justify-content-between border-bottom border-3">
                            <h5 class="text-white fw-bolder mt-3 mb-3 ms-3"><em>LAPORAN DITINJAU</em></h5>
                            <h5 class="text-white fw-bolder align-self-center me-4"><em>{{ $totalTinjauReport }}</em></h5>
                        </div>
                        <div class=" d-flex justify-content-between border-bottom border-3">
                            <h5 class="text-white fw-bolder mt-3 mb-3 ms-3"><em>LAPORAN DIPROSES</em></h5>
                            <h5 class="text-white fw-bolder align-self-center me-4"><em>{{ $totalProsesReport }}</em></h5>
                        </div>
                        <div class=" d-flex justify-content-between">
                            <h5 class="text-white fw-bolder mt-3 mb-3 ms-3"><em>LAPORAN SELESAI</em></h5>
                            <h5 class="text-white fw-bolder align-self-center me-4"><em>{{ $totalSelesaiReport }}</em></h5>
                        </div>
                    </div>
